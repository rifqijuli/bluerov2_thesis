...
def main_control():
    """ Main control loop to set depth and attitude targets.
    """
    ...
    def set_target_depth(master, depth):
    ...
    yawError = runner.horizontalHeadingDifference.get_value()
    pid = control.PIDController(10,0,0,0)
    pid.compute(yawError, 0)
